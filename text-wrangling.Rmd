...
p <- ggplot(names_for_plotting, aes(x = character, y = count, fill = character)) +
  geom_bar(stat = "identity") +
  theme_bw() +
  guides(fill = F) +
  labs(
    title = 'Name Distribution of Chapter {order}'
  ) +
...
ani.options(ani.width = 7)

anim_save("characteranimation.gif", p)
